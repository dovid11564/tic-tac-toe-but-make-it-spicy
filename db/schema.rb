...
ActiveRecord::Schema.define(version: 2023_01_10_201846) do
  ...
  create_table "computer_moves", force: :cascade do |t|
    ...
    t.index ["game_stat_id"], name: "index_computer_moves_on_game_stat_id"
  end
  ...
  create_table "player_moves", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["game_stat_id"], name: "index_player_moves_on_game_stat_id"
  end
  ...
  create_table "winning_boards", force: :cascade do |t|
    t.integer "game_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  add_foreign_key "computer_moves", "game_stats"
  add_foreign_key "game_stats", "games"
  add_foreign_key "games", "users"
  add_foreign_key "player_moves", "game_stats"
  add_foreign_key "winning_boards", "games"
end
